...
// ------------------ OTA CONFIG ------------------
const char* otaUpdateUrl = "http://your-domain.com/firmware.bin"; // Replace with your server URL
const char* otaVersionUrl = "http://your-domain.com/version.txt";  // Replace with your version check URL
